...
public class CriarEquipe extends JFrame implements ActionListener {
	...
	private ImageIcon getImage(String url) {
		ImageIcon imgPersonagem = new ImageIcon(CriarEquipe.class.getResource(url));
	...
	public void actionPerformed(ActionEvent action) {
		...
		case "Coringa":
			name = Nomes.CORINGA;
			url = "/images/coringaEditado.jpg";
			setarImagem(url);
			tratarBotoes();
			break;
		case "Flash":
			name = Nomes.FLASH;
			url = "/images/flashEditado.jpg";
			setarImagem(url);
			tratarBotoes();
			break;
		case "Giganta" :
			name = Nomes.GIGANTA;
			url = "/images/gigantaEditado.jpg";
			setarImagem(url);
			tratarBotoes();
			break;
		case "Lanterna Verde":
			name = Nomes.LANTERNAVERDE;
			url = "/images/lanternaEditado.jpg";
			setarImagem(url);
			tratarBotoes();
			break;
		case "Lex Luthor":
			name = Nomes.LEXLUTHOR;
			url = "/images/lexEditado.jpg";
			setarImagem(url);
			tratarBotoes();
			break;
		case "Lobo":
			name = Nomes.LOBO;
			url = "/images/loboEditado.jpg";
			setarImagem(url);
			tratarBotoes();
			break;
		case "Mulher Maravilha":
			name = Nomes.MULHERMARAVILHA;
			url = "/images/mulherEditado.jpg";
			setarImagem(url);
			tratarBotoes();
			break;
		case "Sinestro":
			name = Nomes.SINESTRO;
			url = "/images/sinestroEditado.jpg";
			setarImagem(url);
			tratarBotoes();
			break;
		case "Superman":
			name = Nomes.SUPERMAN;
			url = "/images/supermanEditado.jpg";
			setarImagem(url);
			tratarBotoes();
			break;
		case "Volcana":
			url = "/images/volcanaEditado.jpg";
			setarImagem(url);
			name = Nomes.VOLCANA;
			tratarBotoes();
		default:
